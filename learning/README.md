...
- **Self-contained learning module:** `learning/dutch-b1-learn.html` — GitHub Pages (best in Edge) or the local server
  ...
  - Dutch TTS: free **Microsoft Edge TTS** — Colette (`nl-NL-ColetteNeural`), no Azure key
  - **GitHub Pages:** works in Microsoft Edge. Chrome/Safari block Microsoft’s WebSocket; use Edge, or the PC server below.
